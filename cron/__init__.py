"""
Cron job scheduling system for Zorro Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    zorro gateway install    # Install as a user service
    sudo zorro gateway install --system  # Linux servers: boot-time system service
    zorro gateway            # Or run in foreground
