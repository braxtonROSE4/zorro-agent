...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("zorro")
        class ZorroToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "zorro", "mistral", "llama3_json")
...
from environments.tool_call_parsers.zorro_parser import ZorroToolCallParser  # noqa: E402, F401
