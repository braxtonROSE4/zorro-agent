...
Inspired by: GroceryMind — production Zorro Agent doing live web research
             across German grocery stores (firecrawl + zorro-agent)
"""
...
# Ensure zorro-agent root is on path
...
class WebResearchEnvConfig(ZorroAgentEnvConfig):
...
class WebResearchEnv(ZorroAgentBaseEnv):
    """
