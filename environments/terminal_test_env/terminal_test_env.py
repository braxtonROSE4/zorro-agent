...
Training tasks (3):
    1. Create ~/greeting.txt with "Hello from Zorro Agent"
...
TRAIN_TASKS = [
    {
        "prompt": "Create a file at ~/greeting.txt containing exactly the text: Hello from Zorro Agent",
        "verify_path": "~/greeting.txt",
        "expected_content": "Hello from Zorro Agent",
    },
    {
...
class TerminalTestEnv(ZorroAgentBaseEnv):
    ...
    def config_init(cls) -> Tuple[TerminalTestEnvConfig, List[APIServerConfig]]:
        ...
        Claude for inference. API keys loaded from ~/zorro-agent/.env.
        """
