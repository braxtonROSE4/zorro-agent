...
TOOLSETS = {
    ...
    # ==========================================================================
    # Full Zorro toolsets (CLI + messaging platforms)
    #
    ...
    "zorro-email": {
        "description": "Email bot toolset - interact with Zorro via email (IMAP/SMTP)",
        "tools": _ZORRO_CORE_TOOLS,
        "includes": []
    },
    ...
    "zorro-sms": {
        "description": "SMS bot toolset - interact with Zorro via SMS (Twilio)",
        "tools": _ZORRO_CORE_TOOLS,
        "includes": []
    },
