# Streaming LLM Response Support for Zorro Agent
...
```
ZORRO_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("ZORRO_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `zorro_cli/config.py` | 1 | +streaming config defaults |
