...
Data file: $ZORRO_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ZORRO_HOME = Path(os.environ.get("ZORRO_HOME", Path.home() / ".zorro"))
DATA_DIR = _ZORRO_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
