...
4. Name the token (e.g., "Zorro Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.zorro/.env`:
...
```bash
CANVAS="python $ZORRO_HOME/skills/productivity/canvas/scripts/canvas_api.py"
