...
_FORCE_SYNC_ENV = "ZORRO_FORCE_FILE_SYNC"
...
def iter_sync_files(container_base: str = "/root/.zorro") -> list[tuple[str, str]]:
    ...
    the hardcoded /root/.zorro to *container_base* because the remote
...
class FileSyncManager:
    ...
    def sync(self, *, force: bool = False) -> None:
        ...
        or ``ZORRO_FORCE_FILE_SYNC=1`` is set.
