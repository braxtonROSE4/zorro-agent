...
def _socket_safe_tmpdir() -> str:
    ...
    append ``agent-browser-zorro_…`` the resulting socket path exceeds the
...
def _find_agent_browser() -> str:
    ...
    Checks in order: current PATH, Homebrew/common bin dirs, Zorro-managed
    ...
    # Build an extended search PATH including Homebrew and Zorro-managed dirs.
    ...
    zorro_node_bin = str(zorro_home / "node" / "bin")
    if os.path.isdir(zorro_node_bin):
        extra_dirs.append(zorro_node_bin)
...
def _run_browser_command(
    ...
    try:
        ...
        # Ensure PATH includes Zorro-managed Node first, Homebrew versioned
...
def _maybe_start_recording(task_id: str):
    ...
    try:
        ...
        recordings_dir = zorro_home / "browser_recordings"
...
def browser_vision(question: str, annotate: bool = False, task_id: Optional[str] = None) -> str:
    ...
    screenshots_dir = get_zorro_dir("cache/screenshots", "browser_screenshots")
