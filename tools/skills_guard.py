...
Trust levels:
  - builtin:   Ships with Zorro. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.zorro/\.env|\~/\.zorro/\.env',
     "zorro_env_access", "critical", "exfiltration",
     "directly references Zorro secrets file"),
    ...
    (r'\.zorro/config\.yaml|\.zorro/SOUL\.md',
     "zorro_config_mod", "critical", "persistence",
     "references Zorro configuration files directly"),
...
def _get_configured_model() -> str:
    """Load the user's configured model from ~/.zorro/config.yaml."""
    try:
