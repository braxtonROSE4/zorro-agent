...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - zorro_home (str): The active ZORRO_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.zorro``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "zorro").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'zorro memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], zorro_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'zorro memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``zorro_home`` is the active ZORRO_HOME directory path.
