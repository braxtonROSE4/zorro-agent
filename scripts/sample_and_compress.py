...
DEFAULT_DATASETS = [
    ...
    "NousResearch/zorro-agent-megascience-sft1",
    "NousResearch/Zorro-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Zorro-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-zorro-agent"
]
