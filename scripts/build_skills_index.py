#!/usr/bin/env python3
"""Build the Zorro Skills Index — a centralized JSON catalog of all skills.
...
`zorro skills search/install` can use it without hitting the GitHub API.
...
# Ensure ZORRO_HOME is set (needed by tools/skills_hub.py imports)
os.environ.setdefault("ZORRO_HOME", os.path.join(os.path.expanduser("~"), ".zorro"))
...
def main():
    print("Building Zorro Skills Index...", flush=True)
