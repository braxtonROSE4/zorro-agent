"""
Skills configuration for Zorro Agent.
`zorro skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.zorro/config.yaml under:
...
from zorro_cli.platforms import PLATFORMS as _PLATFORMS, platform_label
