...
Usage:
    zorro pairing list              # Show all pending + approved users
    zorro pairing approve <platform> <code>  # Approve a pairing code
    zorro pairing revoke <platform> <user_id> # Revoke user access
    zorro pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle zorro pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: zorro pairing {list|approve|revoke|clear-pending}")
        print("Run 'zorro pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'zorro pairing list' to see pending codes.\n")
