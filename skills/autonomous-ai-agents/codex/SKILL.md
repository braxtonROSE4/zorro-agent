...
metadata:
  zorro:
    ...
    related_skills: [claude-code, zorro-agent]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Zorro terminal. Codex is OpenAI's autonomous coding agent CLI.
