...
## Zorro Agent Integration

This skill is designed for the Zorro Agent. It uses Zorro tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Zorro skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.zorro/plans/` | `skill_view("plan")` |
