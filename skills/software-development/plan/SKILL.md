...
- Your deliverable is a markdown plan saved inside the active workspace under `.zorro/plans/`.
...
- `.zorro/plans/YYYY-MM-DD_HHMMSS-<slug>.md`
...
If not, create a sensible timestamped filename yourself under `.zorro/plans/`.
