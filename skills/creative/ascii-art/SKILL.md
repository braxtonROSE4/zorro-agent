...
```bash
python3 -m pyfiglet "ZORRO" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=ZORRO&font=Slant" | boxes -d stone
```
