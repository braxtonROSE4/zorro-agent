...
Built for [Zorro Agent](https://github.com/NousResearch/zorro-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/zorro-agent/skills/creative/ascii-video`](https://github.com/NousResearch/zorro-agent/tree/main/skills/creative/ascii-video) via PR.
