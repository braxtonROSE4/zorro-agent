...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        tokens_file = get_zorro_home() / "slack_tokens.json"
        ...
        try:
            ...
            @self._app.command("/zorro")
            async def handle_zorro_command(ack, command):
                await ack()
            ...
            for _action_id in (
                "zorro_approve_once",
                "zorro_approve_session",
                "zorro_approve_always",
                "zorro_deny",
            ):
                    ...
                    "elements": [
                        {
                            ...
                            "style": "primary",
                            "action_id": "zorro_approve_once",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Allow Session"},
                            "action_id": "zorro_approve_session",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Always Allow"},
                            "action_id": "zorro_approve_always",
                            "value": session_key,
                        },
                        {
                            "type": "button",
    ...
    async def _handle_approval_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "zorro_approve_once": "once",
            "zorro_approve_session": "session",
            "zorro_approve_always": "always",
            "zorro_deny": "deny",
        }
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        from zorro_cli.commands import slack_subcommand_map
