"""
Email platform adapter for the Zorro gateway.

Allows users to interact with Zorro by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Zorro Agent")
        ...
        msg_id = f"<zorro-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
